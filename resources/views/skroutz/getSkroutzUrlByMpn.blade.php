                        ...
                        @foreach($mpn_list as $mpn)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 bg-yellow-50">
                                    @if($mpn->skroutz_url)
                                        <a href="{{$mpn->skroutz_url}}" class="text-blue-600 underline" target="_blank">Άνοιγμα</a>
                                    @else
                                        --
                                    @endif
                                ...
                                <td class="px-6 py-4 whitespace-nowrap bg-red-50">
                                    @if($mpn->returns_one_product_best_price)
                                        <span
                                            class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-200 text-gray-800">
                                        @else
                                                <span
                                ...
                                <td class="px-6 py-4 whitespace-nowrap bg-red-50">
                                    @if($mpn->is_processed_best_price)
                                        <span
                                            class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-200 text-gray-800">
                                        @else
                                                <span
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 bg-red-50">
                                    @if($mpn->best_price_url)
                                        <a href="{{$mpn->best_price_url}}" class="text-blue-600 underline" target="_blank">Άνοιγμα</a>
                                    @else
                                        --
                                    @endif
