                ...
                <div class="">
                    ...
                    <div class="dropdown inline-block relative">
                        ...
                        <ul class="dropdown-menu absolute hidden text-gray-700 pt-1">
                            <li class=""><a class="rounded-t bg-gray-100 hover:bg-blue-100 py-2 px-4 block whitespace-no-wrap" href="#">Εύρεση με MPN</a></li>
                            <li class=""><a class="bg-gray-100 hover:bg-blue-100 py-2 px-4 block whitespace-no-wrap" href="#">Εύρεση με EAN</a></li>
                            <li class=""><a class="rounded-b bg-gray-100 hover:bg-blue-100 py-2 px-4 block whitespace-no-wrap" href="#">Placeholder</a></li>
                        </ul>
                    </div>
